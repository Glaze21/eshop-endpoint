...
const products: Product[] = [
  ...
  new Product("Unbranded Steel Shoes")
    .setId("unbranded-steel-shoes")
    .setPrice(225)
    .setDescription("<p>Enjoy these sneakers</p>")
    .addImages([
      "https://images.squarespace-cdn.com/content/v1/5442b6cce4b0cf00d1a3bef2/1630607200172-64CEARCJE6YXEIMH9M5U/15-ethical-shoe-brands-for-every-occasion-allbirds",
    ])
    .setCategory(Category.clothes)
    .setBrand("Unbranded")
    .addAttributeSet(shoeSizes),
  ...
  new Product("Regular blue shirt")
    .setId("blue-shirt")
    .setPrice(24.99)
    .addImages(["https://www.rei.com/media/product/140889"])
    .addAttributeSet(clothesSizes)
    .setBrand("AVAN")
    .setDescription("<p>Awesome winter jacket</p>")
    .setCategory(Category.clothes),
